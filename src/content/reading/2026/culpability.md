...
a sculpture by Cheyney Thompson I saw at The Whitney in 2019. 3D random walks were
...
simplest of rules and can create beautiful shapes, but they don't know about
...
will behave when they encounter the world that we inhabit. Even when deep learning systems
start to pick out their own patterns in their training data, they're learning from the
biases and imperfections of what we choose to include and what we choose to omit from
their training.
...
be a single answer? Do we need there to be one?
